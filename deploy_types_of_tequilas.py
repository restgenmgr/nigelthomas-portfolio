#!/usr/bin/env python3
"""
ONE-SHOT DEPLOY: Types of Tequilas page  ->  nigelthomas.live

Run from the repo root:
    cd C:\\Users\\admin\\Desktop\\nigelthomas-portfolio
    python deploy_types_of_tequilas.py

Put these 3 files in the SAME folder as this script (the repo root is fine):
    types-of-tequilas.html  (self-contained page, poster embedded)
    types-of-tequilas.png   (poster, also used for og:image)
    deploy_types_of_tequilas.py
...
# ------------------------------------------------------------------ CONFIG
SLUG = 'types-of-tequilas'
DOMAIN = 'https://www.nigelthomas.live'
PAGE_TITLE = 'Types of Tequila and the Top 10 Tequila Brands: A Guide for Bar Professionals'
LINK_TITLE = 'Types of Tequila and the Top 10 Tequila Brands: A Guide for Bar Professionals'
CARD_META = 'September 20, 2026 &middot; 11 min read &middot; Bar &amp; Beverage'
CARD_EXCERPT = ('Blanco, joven, reposado, anejo, extra anejo and cristalino explained, how tequila is made, tequila vs mezcal, '
                'label reading, serving tips and 10 iconic brands, with a free downloadable poster.')
CARD_ALT = 'Types of Tequilas and Top 10 Tequila Brands poster'
LASTMOD = '2026-09-20'
LIVE_CHECK_TEXT = 'Types of Tequila'
COMMIT_MSG = 'Add Types of Tequilas guide page, poster, sitemap and blog card; cross-link bar pages'
# --------------------------------------------------------------------------
